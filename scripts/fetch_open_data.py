...
SOURCE_URL = "https://openlibrary.org/search.json?q=judas&limit=100&fields=key,title,author_name,first_publish_year,language"
PACK = "open-books"
...
def fetch(url: str = SOURCE_URL, timeout: float = 30.0):
    req = urllib.request.Request(url, headers={"User-Agent": "belentani-the-judas-experience-open-data/1.0"})
